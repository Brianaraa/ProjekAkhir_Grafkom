...
class Bola(BaseShape):
    ...
    Menerapkan Proyeksi Perspektif nyata + Rotasi 3D penuh (WASDQE).
    """
    ...
    def to_dict(self):
        """Alur Data untuk Save: Mencatat koordinat 3D murni + sudut rotasi."""
        data = super().to_dict()
